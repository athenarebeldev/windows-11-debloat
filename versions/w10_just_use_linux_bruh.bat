...
:: =================================================================
::  just_use_linux_bruh_W10.bat v1.0 (The Windows 10 Edition)
:: =================================================================

set "SCRIPT_NAME=just_use_linux_bruh (Windows 10)"
set "VERSION=1.0"
...
powershell -Command "Write-Host -ForegroundColor Yellow '================================================================='"
echo.
echo  Welcome! This utility helps you manage common Windows 10 settings.
...
echo.
powershell -Command "Write-Host -ForegroundColor Cyan ' [1] Edge Copilot Settings'"
...
:COPILOT_MENU
cls
powershell -Command "Write-Host -ForegroundColor Yellow '==================== EDGE COPILOT SETTINGS ====================='"
echo.
powershell -Command "Write-Host -ForegroundColor Cyan ' [1] Disable Copilot in Microsoft Edge'"
powershell -Command "Write-Host -ForegroundColor Cyan ' [2] Enable Copilot in Microsoft Edge'"
powershell -Command "Write-Host -ForegroundColor Cyan ' [0] Back to Main Menu'"
echo.
choice /N /C 120 /M "Select an option: "
if errorlevel 3 goto MAIN_MENU
...
powershell -Command "Write-Host -ForegroundColor Cyan ' [3] Taskbar News and Interests (Removes the Weather feed)'"
...
:WIDGETS_MENU
cls & echo [1] Disable News and Interests  [2] Enable News and Interests  [0] Back & choice /N /C 120
...
call :ACTION_FOOTER & goto DEBLOAT_MENU
:DISABLE_COPILOT
call :ACTION_HEADER & call :CHECK_ADMIN & echo    -> Disabling Edge Copilot... & timeout /t 1 >nul & call :DISABLE_COPILOT_LOGIC & call :ACTION_FOOTER & goto COPILOT_MENU
:ENABLE_COPILOT
call :ACTION_HEADER & call :CHECK_ADMIN & echo    -> Enabling Edge Copilot... & timeout /t 1 >nul & call :ENABLE_COPILOT_LOGIC & call :ACTION_FOOTER & goto COPILOT_MENU
:DISABLE_EDGE
...
:DISABLE_WIDGETS
call :ACTION_HEADER & call :CHECK_ADMIN & echo    -> Disabling News and Interests... & timeout /t 1 >nul & call :DISABLE_WIDGETS_LOGIC & call :ACTION_FOOTER & goto DEBLOAT_MENU
:ENABLE_WIDGETS
call :ACTION_HEADER & call :CHECK_ADMIN & echo    -> Enabling News and Interests... & timeout /t 1 >nul & call :ENABLE_WIDGETS_LOGIC & call :ACTION_FOOTER & goto DEBLOAT_MENU
:DISABLE_CORTANA
...
reg add "%REG_KEY_EDGE_COpilot%" /v "%REG_VAL_EDGE_COpilot%" /t REG_DWORD /d 0 /f >nul & goto:eof
:ENABLE_COPILOT_LOGIC
reg delete "%REG_KEY_EDGE_COpilot%" /v "%REG_VAL_EDGE_COpilot%" /f >nul 2>&1 & goto:eof
:DISABLE_EDGE_LOGIC
...
echo.
echo    --- MICROSOFT EDGE COPILOT (Disable value shown) ---
